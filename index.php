...
<?php
if (isset($_GET["err"]) && $_GET["err"]=='pwd'){
echo "<div><span style='font-weight:bold;font-size:18pt;color:red;'>帳號密碼錯誤！</span></div>";
}
?>
<div class="wrapper">
    ...
    <div class="group">
      ...
      <div class="one_third">
        <article class="service"><i class="icon orange circle fa fa-bicycle"></i>
          ...
          <p><a href="#"style="font-size:16px; line-height:20px">晚安 &raquo;</a></p>
        </article>
      </div>
      <div class="one_third">
