...
<header style="background-image: url(../images/back.jpg); ">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <h1 class="display-4 fw-bolder" style="border-width: 3px ;  padding: 5px; text-align: center; background-color: rgb(255, 255, 255, 0.7);border-radius: 4px;color:#4F4F4F;">校園數位美食購</h1>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="card text-white bg-secondary my-5 py-4 text-center" style="padding:0px;">
            <center>    
            <div class="card-body" style="width:270px;">
                  <span style="float:left;"><img src="../images/store/3.jpg" style="max-height:80px;"></span>
                  <span class="text-white m-0" style="font-size: 3em;float:left;padding-left: 10px;">
                  <a href="food_list.php?store_id=3" style="color:white;">呷尚寶</a>
                  </span>
                  
                  <span style="padding-left: 10px;padding-top:20px;float:left;font-size:18px;">推薦商品：乳酪餅</span>
                </div>
            </div>  
        </center>
            ...
            while ($row = $result->fetch_assoc())  {
              echo '<div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">'.$row["store_name"]. '</h2>
                            <p class="card-text">'.$row["address"]. '</p>
                        </div>
                        <div class="card-footer"><a class="btn btn-primary btn-sm" href="food_list.php?store_id='.$row["store_id"].'">進入</a></div>
                    </div>
